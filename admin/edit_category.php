            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                ...
                <form action="post.php" method="POST" style="padding:40px;" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="category" name="category_name" value="<?php echo $name; ?>" required>
                    ...
                    <div class="form-group row justify-content-center text-center">
                        <div>
                            <input type="submit" name="editCategory" class="btn btn-success">
                        </div>
                    </div>
